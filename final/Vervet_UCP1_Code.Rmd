...
vcf-subset -c southernexpansion_list ALL_UPC1.vcf.gz | bgzip  -c > se_UCP1.vcf.gz #isolate only pygerythrus samples

zgrep -v "^##" se_UCP1.vcf.gz | cut -f1-3 > UCP1_loci.txt #Get list of variant sites for LD

#UCP2
tabix -h  163_201701_UG_vervet_monkey_SNPs_all_chrom_beagle_shapeit.vcf.gz CAE1:65228307-65256886 | bgzip -c > ALL_UPC2.vcf.gz #isolate UCP1 region for all samples

vcf-subset -c southernexpansion_list ALL_UPC2.vcf.gz | bgzip  -c > se_UCP2.vcf.gz #isolate only pygerythrus samples

zgrep -v "^##" se_UCP2.vcf.gz | cut -f1-3 > UCP2_loci.txt #Get list of variant sites for LD

#UCP3
tabix -h  163_201701_UG_vervet_monkey_SNPs_all_chrom_beagle_shapeit.vcf.gz CAE2:65259611-65289050 | bgzip -c > ALL_UPC3.vcf.gz #isolate UCP1 region for all samples

vcf-subset -c southernexpansion_list ALL_UPC3.vcf.gz | bgzip  -c > se_UCP3.vcf.gz #isolate only pygerythrus samples
